    ...
    <div className="min-h-screen bg-gray-50 flex flex-col font-sans">
      ...
      <section className="bg-[#f5f5f7] pt-10 pb-0 px-4 overflow-hidden">
        <div className="max-w-lg mx-auto text-center">
          ...
          >
            Sécurisez votre album rigide avec 30, 60 ou 90 pochettes de stickers incluses.
          </motion.p>
          ...
          >
            ...
            >
              Commander <ShoppingBag className="w-5 h-5" />
            </button>
      ...
      <section className="bg-[#6b0f1a] py-3 px-4 text-white">
        <div className="max-w-4xl mx-auto flex flex-wrap items-center justify-center divide-x divide-white/20">
          {[
            ...
            { stat: "670+", label: "stickers dans l'album" },
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-14">
            ...
            <p className="text-gray-500 max-w-xl mx-auto">
              Plus vous avez de pochettes, plus vite vous complétez l'album ! Livraison gratuite sur toute la France.
            </p>
          </div>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-10">
            <h2 className="text-2xl md:text-3xl font-black text-gray-900 mb-2">
              L'album de stickers le plus attendu au monde
            </h2>
            <p className="text-gray-500 max-w-2xl mx-auto text-sm">
              Depuis 1970, Panini est la marque mondiale de référence pour les stickers de football. L'album FIFA World Cup 26™ est le seul produit officiellement licencié par la FIFA.
            </p>
          </div>
          ...
          <div className="flex flex-wrap items-center justify-center gap-8 mb-12 py-6 border-y border-gray-100">
            ...
            <div className="flex flex-col items-center gap-1 text-center">
              ...
              <span className="text-xs text-gray-400 uppercase tracking-wider font-medium">stickers/an</span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            <div className="flex gap-4 items-start bg-gray-50 rounded-2xl p-5 border border-gray-100">
              ...
              <div>
                <h4 className="font-bold text-gray-900 text-sm mb-1">Licence Officielle FIFA</h4>
                <p className="text-xs text-gray-500 leading-relaxed">Le seul album officiellement licencié FIFA pour la Coupe du Monde 2026. Produit 100% authentique.</p>
              </div>
            </div>
            <div className="flex gap-4 items-start bg-gray-50 rounded-2xl p-5 border border-gray-100">
              <div className="w-10 h-10 rounded-xl bg-[#6b0f1a]/10 flex items-center justify-center flex-shrink-0">
              ...
              <div>
                <h4 className="font-bold text-gray-900 text-sm mb-1">100% Scellé Usine</h4>
                <p className="text-xs text-gray-500 leading-relaxed">Tous les colis arrivent avec le sceau d'usine intact. Jamais ouvert, jamais altéré.</p>
              </div>
            </div>
            <div className="flex gap-4 items-start bg-gray-50 rounded-2xl p-5 border border-gray-100">
              <div className="w-10 h-10 rounded-xl bg-[#6b0f1a]/10 flex items-center justify-center flex-shrink-0">
              ...
              <div>
                <h4 className="font-bold text-gray-900 text-sm mb-1">Livraison Suivie</h4>
                <p className="text-xs text-gray-500 leading-relaxed">Expédié avec numéro de suivi. Livraison en {countryConfig.deliveryTime}.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-2xl mx-auto">
          <div className="text-center mb-8">
            ...
            <h2 className="text-2xl md:text-3xl font-black text-gray-900 leading-tight">
              Le plus grand album de la Coupe du Monde
            </h2>
          </div>

          <div className="grid grid-cols-2 gap-3 mb-4">
            {[
              { stat: "112", label: "Pages", sub: "Le plus grand album Panini de l'histoire" },
              { stat: "670+", label: "Stickers", sub: "Stickers uniques dans l'album" },
              { stat: "7", label: "Stickers/pochette", sub: "Plus de stickers par pochette" },
              { stat: "48", label: "Équipes", sub: "Toutes les nations qualifiées" },
            ].map((s, i) => (
          ...
          <p className="text-center text-xs text-gray-400 mb-12">
            3e édition historique — Coupe du Monde 26 avec 48 équipes
          </p>
          ...
          <div className="grid grid-cols-2 gap-3 mb-6">
            {[
              { emoji: "🚚", title: "Livraison prioritaire", desc: "Soyez parmi les premiers à le recevoir" },
              { emoji: "🎁", title: "Remise exclusive", desc: "Disponible uniquement dans cette offre en ligne" },
              { emoji: "✅", title: "Produit Panini officiel", desc: "Authenticité garantie" },
              { emoji: "📦", title: "Livraison gratuite", desc: "Gratuite partout en France" },
            ].map((b, i) => (
          ...
          <p className="text-center text-xs text-gray-400">
            ✓ Livraison gratuite &nbsp;·&nbsp; ✓ Produit original
          </p>
        </div>
      </section>
      ...
      <section className="bg-gray-50 py-20 px-4 border-t border-gray-100">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-sm text-gray-500 font-medium">Excellent · +2 200 avis</p>
          </div>
      ...
      <section className="py-10 px-4 bg-gray-50 border-t border-gray-100 text-center">
        <div className="max-w-xl mx-auto">
          <p className="text-sm text-gray-500 mb-4 flex items-center justify-center gap-2">
            ...
            Stock limité — l'offre peut prendre fin à tout moment
          </p>
          <button
          ...
          >
            Sécuriser Mon Kit <ShoppingBag className="w-5 h-5" />
          </button>
        </div>
      </section>
      ...
      <section className="py-12 px-4 bg-gray-50 border-t border-gray-100">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-xl font-black text-gray-900 text-center mb-8">Pourquoi acheter chez nous ?</h2>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              { icon: <Truck className="w-6 h-6" />, title: "Livraison rapide", desc: "2–4 jours ouvrés dans toute la France" },
              { icon: <Award className="w-6 h-6" />, title: "Produit officiel", desc: "Licence officielle FIFA & Panini" },
              { icon: <Lock className="w-6 h-6" />, title: "Paiement sécurisé", desc: "Paiement protégé + SSL" },
              { icon: <ShieldCheck className="w-6 h-6" />, title: "Sans risque", desc: "Satisfaction garantie" },
            ].map((w, i) => (
