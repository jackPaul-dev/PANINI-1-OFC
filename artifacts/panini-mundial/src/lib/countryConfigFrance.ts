import type { Kit, OrderBump, Review, TaxField } from "./countryConfig";

const countryConfigFrance = {
  ...
  currency      : "EUR",
  currencySymbol: "€",
  stripeLocale  : "fr" as const,

  phonePlaceholder: "+33 6 00 00 00 00",
  taxField        : null as TaxField,
  floorField      : false,
...
export default countryConfigFrance;
